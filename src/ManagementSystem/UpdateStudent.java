...
public class UpdateStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, -1, -1));
        ...
        add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, 110, -1));
        add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 110, -1));
        add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 100, 110, -1));
        add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 140, 110, -1));
        add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 110, -1));
        add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 220, 110, -1));
        ...
        add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 260, -1, -1));
        ...
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 260, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int result = 0;
        result = physicsMarks + chemistryMarks + mathsMarks + electricalMarks + bioMarks;

        try{
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.executeUpdate("update result set physics=" + physicsMarks +", maths="+ mathsMarks +", chem="+ chemistryMarks +", electrical="+ electricalMarks +", bio="+ bioMarks + ", result=" + result+ " where rollNo='"+ rollNo +"'");
